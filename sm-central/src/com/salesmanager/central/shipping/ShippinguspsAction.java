...
public class ShippinguspsAction extends ShippingModuleAction {

	private final static String moduleid = "usps";

	private Logger log = Logger.getLogger(ShippinguspsAction.class);
	...
	public void displayModule() throws Exception {
		if (configurations != null) {
			...
			Map selectedservices = (Map) configurations
					.getConfiguration("service-global-usps");
	...
	public void prepareModule() throws Exception {
		...
		Map servicemap = ShippingUtil.buildServiceMapLabelByCode(moduleid,
				locale);
		if (servicemap != null) {
