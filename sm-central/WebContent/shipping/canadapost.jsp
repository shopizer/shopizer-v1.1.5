...
<div class="page-content">
                <p><s:text name="label.shipping.canadapost.activation" /></p>


                <s:action id="refAction" namespace="/ref" name="ref"/>

				<s:form name="canadapost" action="/shipping/canadapost_save.action" method="post">
                    ...
                    <s:textfield name="keys.userid" value="%{keys.userid}" label="%{getText('label.shipping.rates.canadapost.userid')}" size="40" required="true"/>
                    ...
                    <s:submit action="canadapost_delete" value="%{getText('button.label.removeservice')}"/>
