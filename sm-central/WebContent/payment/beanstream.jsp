...
<div class="page-content">
				...
				<s:form name="psigate" action="beanstream_save.action" method="post">
				...
				<s:textfield name="keys.transactionKey" value="%{keys.transactionKey}" label="%{getText('label.payment.methods.beanstream.storeid')}" size="40" required="true"/>
				<s:textfield name="keys.userid" value="%{keys.userid}" label="%{getText('label.payment.methods.beanstream.userid')}" size="40" required="true"/>
				<s:password name="keys.password" value="%{keys.password}" label="%{getText('label.payment.methods.beanstream.password')}" size="40" required="true"/>
