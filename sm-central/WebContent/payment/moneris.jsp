...
<div class="page-content">
				...
				<s:form name="moneris" action="moneris_save.action" method="post">
				...
				<s:textfield name="keys.userid" value="%{keys.userid}" label="%{getText('label.payment.methods.moneris.storeid')}" size="40" required="true"/>
				<s:textfield name="keys.transactionKey" value="%{keys.transactionKey}" label="%{getText('label.payment.methods.moneris.transactionkey')}" size="40" required="true"/>
				...
				<s:radio label="%{getText('label.payment.methods.environment')}" name="properties.properties2" list="#refAction.environments" value="%{properties.properties2}" required="true"/>
                    ...
                    <s:submit action="moneris_delete" value="%{getText('button.label.removeservice')}"/>
