...
function createRelationship(productId) {
	...
	AddProduct.addRelationshipItem(productId,'-1','0',fillRelationship);
}
...
function removeRelationship(productId) {
	document.getElementById('ajaxMessage').innerHTML='';
	AddProduct.removeRelationshipItem(productId,'-1','0',unfillRelationship);
}
		...
		<table width="100%">
			...
			<tr>
				...
				<td colspan="2">
				  ...
				  <div class="notes">
					<h4><s:text name="label.storefront.featureditems.configuration" />&nbsp;
					<s:text name="label.payment.generic.information" /></h4>
					<p class="last">
						<s:text name="label.storefront.featureditems.text" />
					</p>
				  </div>
            ...
            <div class="dragZoneContainer">
				...
				<td align="right">
            		...
            		<div class="dropZoneHeader"><s:text name="label.storefront.featureditems" /></div>
					<div id="interaction" class="dropZoneContainer">
               	  

                    		<div class="dropZone">
				    		<s:iterator value="featuredItems" >
